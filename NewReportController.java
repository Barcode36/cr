    ...
    public void handleButtonAction(ActionEvent event) throws IOException
    {
        ...
        { //Envoi du rapport
            ...
            else
            {
                ...
                error.setTitle("Erreur lors de l'ajout");
                error.setHeaderText("Ajout non effectué");
                error.setContentText("Le rapport n'a pas été ajouté, veuillez réessayer plus tard.");
                error.showAndWait();
            }
        }
    }
